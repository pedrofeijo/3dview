...
for i in range(len(dados_x)//intervalo):
    ...
    fig.savefig('/home/feijo/Documents/carvao_ufc/pilha1teste/fig_{}.png'.format(i))
    print(i) 
    plt.close()

#identificar o numero de slices na path
folder = '/home/feijo/Documents/carvao_ufc/pilha1teste' # path dos slices
...
for i in range(len(filepaths)):
    img = np.asarray(Image.open("/home/feijo/Documents/carvao_ufc/pilha1teste/fig_{}.png".format(i)).convert('L'))
